<template>
  <div>
    ...
    <section style="overflow:auto;flex:1">
        ...
        <van-swipe :autoplay="3000" indicator-color="white">
          <van-swipe-item v-for="(item, index) in list" :key="index">
            <router-link to="/vegetable">
              <van-image width="100%" height="200" :src="item.banner_img_url"/>
            </router-link>
          </van-swipe-item>
        </van-swipe>
      </van-row>
      <!-- 轮播结束 -->
      <!-- 分类展示 -->
      <van-row type="flex" justify="space-around" style="font-size:70%;">
        <van-col span="4">
          <router-link
            to="/vegetable"
          ...
          >
            <van-image
              width="100%"
              height="100%"
              src="https://ss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=20270,2237849674&fm=26&gp=0.jpg"
            />米面粮油
          </router-link>
        </van-col>
        <van-col span="4">
          ...
          >
            <van-image src="http://www.cnyoucai.com/upload/1/2016/08/31/57c68e2ecf679.jpg"/>新鲜蔬菜
          </router-link>
        </van-col>
        <van-col span="4">
          <router-link
            to="/vegetable"
            style="display:flex;flex-direction:column;align-items:center;width:80%;height:80%;"
          >
            <van-image
              src="https://ss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=2632223247,1271230217&fm=27&gp=0.jpg"
            />休闲酒饮
          </router-link>
        </van-col>
        <van-col span="4">
          ...
          >
            <van-image
              src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1561200543910&di=c71f456afe00a4044009737191eb61cd&imgtype=0&src=http%3A%2F%2Fimg.pconline.com.cn%2Fimages%2Fupload%2Fupc%2Ftx%2Fpc_best%2F1806%2F26%2Fc52%2F94593690_1530010526516.jpg"
            />鲜蛋
          </router-link>
        </van-col>
        <van-col span="4">
          ...
          >
            <van-image
              width="100%"
              height="100%"
              src="http://img0.imgtn.bdimg.com/it/u=584785056,918066&fm=26&gp=0.jpg"
            />肉畜
          </router-link>
        </van-col>
      </van-row>
      <van-row type="flex" justify="space-around" style="padding:5% 0;border-bottom:1px solid #000;font-size:70%;">
        <van-col span="4">
          <router-link
            to="/vegetable"
            style="display:flex;flex-direction:column;align-items:center;"
          >
            <van-image
              src="https://ss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=817446964,3458164654&fm=26&gp=0.jpg"
            />为我推荐
          </router-link>
        </van-col>
        <van-col span="4">
          ...
          >
            <van-image
              src="http://www.007mc.cn/images/201405/thumb_img/259_thumb_G_1399355023030.jpg"
            />常用清单
          </router-link>
        </van-col>
        <van-col span="4">
          ...
          >
            <van-image
              width="100%"
              height="100%"
              src="http://img5.imgtn.bdimg.com/it/u=532297234,733544617&fm=26&gp=0.jpg"
            />调料干货
          </router-link>
        </van-col>
        <van-col span="4">
          ...
          >
            <van-image
              width="100%"
              height="100%"
              src="https://ss2.baidu.com/6ONYsjip0QIZ8tyhnq/it/u=3595054463,3689174254&fm=58&bpow=2100&bpoh=1401"
            />餐厨用品
          </router-link>
        </van-col>
        <van-col span="4">
          ...
          >
            <van-image
              src="http://www.007mc.cn/images/201306/thumb_img/89_thumb_G_1370218183730.jpg"
            />方便菜
          </router-link>
        </van-col>
      </van-row>
